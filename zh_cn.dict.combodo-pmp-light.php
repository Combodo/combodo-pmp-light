...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:lnkContactToTicket/Attribute:category' => '类型',
	'Class:lnkContactToTicket/Attribute:category/Value:1' => '客户',
	'Class:lnkContactToTicket/Attribute:category/Value:2' => '资源',
	'Class:lnkContactToTicket/Attribute:influence' => '影响',
	'Class:lnkContactToTicket/Attribute:influence/Value:objector' => ' 反对者',
	'Class:lnkContactToTicket/Attribute:influence/Value:partner' => '合作者',
	'Class:lnkContactToTicket/Attribute:influence+' => '在此项目的表现',
	...
	'Class:lnkContactToWBS' => '关联联系人/WBS',
	...
	'Class:lnkContactToWBS/Attribute:influence' => '影响',
	'Class:lnkContactToWBS/Attribute:influence+' => '在此项目的表现',
	'Class:lnkContactToWBS/Attribute:influence/Value:objector' => '反对者',
	'Class:lnkContactToWBS/Attribute:influence/Value:partner' => '合作者',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:Project/Attribute:status/Value:closed' => '已关闭',
	...
	'Class:Project/Stimulus:ev_monotir' => '进入监控',
	'Class:Project/Stimulus:ev_plan' => '计划',
	'Class:Project/Stimulus:ev_reexecute' => '返回执行',
	'Class:Project/Tab:Summary' => '汇总',
	'Class:Project/Tab:Summary+' => '当前项目的汇总',
    ...
    'Class:Project/Attribute:project_completion+' => '交付成果完成水平',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:WBS+' => '交付成果的WBS列表',
	'WBS:Cost' => '费用',
	'WBS:Dates' => '日期',
	'WBS:Error:ParentCantBeChildren' => '不能设定自身为父级交付成果',
	'WBS:Execution' => '执行',
	'WBS:Info' => '信息',
	'Class:WBS/Error:Contactnotfound' => '%1$s没有设置为项目相关的利益相关者? 需要进行添加.',
	...
	'Menu:NewWBS' => '新建交付成果',
	'Menu:WBSMenu' => '交付成果',
	'Menu:SearchWBS' => '搜索交付成果',
	'UI-WBSManagementOverview-OpenWBSByProject' => '打开的交付成果 (按客户项目)',
));
